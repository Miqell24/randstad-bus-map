...
export const RULES = { prefer: ['Den Haag, Van Musschenbroekstraat'], style: 'title',
  // The Hague has ONE name on this sheet — the one its own signs use
  stopRe: [[/^'s-Gravenhage, /, 'Den Haag, '], [/\bIjssel\b/g, 'IJssel']],
};
